...
PS1="$PS1\$(echo '\w' | sed -r 's/^.*.(.{90})/<\1/') $WHITE)--\n└-$ $NOCOLOR"
...
alias nodeTunnel="ssh -L 7000:localhost:7001 esekits5034.rnd.ki.sw.ericsson.se nodeTunnel.sh \!*"
alias cudbHUB="ssh -Y esekilxxen2631.rnd.ericsson.se"
...
alias gedit="vim"
alias changeMirrorInternet="sudo /opt/elx/bin/change-apt-mirror internet"
alias changeMirrorEricsson="sudo /opt/elx/bin/change-apt-mirror ericsson"
