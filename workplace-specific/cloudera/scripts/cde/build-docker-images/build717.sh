...
cd $DEX_HOME/docker
set -e
echo "***Building public cloud images"
bash -c "DEX_HOME=${DEX_HOME} ENABLE_MULTI_ARCH_BUILD=false FORM_FACTOR=pc CDP_PLATFORM=7.1.7 make dex-spark3-runtime-v2 dex-livy-runtime-spark3-v2  dex-runtime-python-builder-v2 REGISTRY=${REGISTRY} VERSION=${VERSION} BUILD_TYPE=${BUILD_TYPE}"

echo "***Building private cloud images"
