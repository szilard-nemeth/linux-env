...
TASKDIR_LOCAL=$HOME/development/my-repos/knowledge-base-private/cloudera/tasks/cde/DEX-17194/testing-results-local/
...
TASKDIR_YCLOUD=$HOME/development/my-repos/knowledge-base-private/cloudera/tasks/cde/DEX-17194/testing-results-from-ycloud/
