...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        default=True,
        help="Whether to use git log --oneline",
    )
    parser.add_argument(
        "-a", "--author", dest="author", type=str, required=False, default=False, help="Grep for authors"
    )
    parser.add_argument(
        "-c", "--committer", dest="committer", type=str, required=False, default=False, help="Grep for committers"
    )
    parser.add_argument(
        "-C",
        "--count",
        ...
        required=False,
        default=False,
        help="Whether to return count of commits",
    )
    parser.add_argument(
        "-tc",
        "--trim-count",
        ...
        required=False,
        default=False,
        help="Whether to trim whitespaces from count output",
    )
    parser.add_argument(
        "-fg",
        "--final-grep",
        ...
        type=str,
        required=False,
        help="Whether to apply a final grep for the command",
    )
