...
## LINUX-ENV ALIASES
alias linuxenv-reload="cp ~/development/my-repos/linux-env/setup-env.sh ~/.linuxenv/setup-env.sh && cp ~/development/my-repos/linux-env/.zshrc ~/ && $LINUX_ENV_REPO/setup-env.sh"
